...
val defaultWorkouts = listOf(
    ...
    Workout("Standard w/o Jumps", listOf(1,3,5,6,7,8,9,10,11,13,14,17,18,19,24,26,27,28,29,30,31,33,34,35,36,38,40,42,43,44,45,46,47,48,50,51,52,55,57,59,60,61,62,66,67,68,69,71,72,73,75,77,78,80,81,83,84,85,86,87)),
